...
export function KeyRotateIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <circle cx="7.5" cy="15.5" r="4.5" />
      <path d="M12 11l8.5-8.5M17 2l2 2-1.5 1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20 6l1.5 1.5" strokeLinecap="round" />
    </svg>
  )
}
