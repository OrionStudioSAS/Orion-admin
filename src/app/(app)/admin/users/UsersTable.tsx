      ...
      {showCreate && (
        <form onSubmit={handleCreateUser} className="bg-[#0f0f0f] border border-white/10 rounded-2xl p-4 md:p-6 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block text-[10px] text-[#a1a1aa] uppercase tracking-widest mb-2">Nom complet</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-[10px] text-[#a1a1aa] uppercase tracking-widest mb-2">Email *</label>
              <input
                type="email"
                value={newUser.email}
            ...
            <div>
              <label className="block text-[10px] text-[#a1a1aa] uppercase tracking-widest mb-2">Mot de passe *</label>
              <input
                type="password"
            ...
            <div>
              <label className="block text-[10px] text-[#a1a1aa] uppercase tracking-widest mb-2">Rôle</label>
              <select
                value={newUser.role}
          ...
          <div className="flex gap-3">
            ...
            <button type="button" onClick={() => setShowCreate(false)} className="text-[#a1a1aa] text-xs px-4 py-2 rounded-lg hover:text-white hover:bg-white/5 transition-all">
              Annuler
            </button>
          </div>
        </form>
              ...
              <div className="flex items-center gap-2 md:gap-4 px-3 md:px-5 py-3 md:py-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-medium text-white">
                    {profile.full_name || '—'}
                    {isCurrentUser && <span className="ml-2 text-[10px] text-[#a1a1aa]">(vous)</span>}
                  </div>
                  <div className="text-xs text-[#a1a1aa]">
                    {profile.email}
                    {profile.company && <span className="ml-2 text-[#a1a1aa]">· {profile.company}</span>}
                  </div>
                </div>
                ...
                <Link
                  ...
                  className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg text-[#a1a1aa] hover:text-white hover:bg-white/5 transition-all"
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg transition-all
                    ${isEditing ? 'bg-white text-black' : 'text-[#a1a1aa] hover:text-white hover:bg-white/5'}`}
                >
